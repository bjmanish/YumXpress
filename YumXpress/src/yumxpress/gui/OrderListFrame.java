...
public class OrderListFrame extends javax.swing.JFrame {
    ...
    public OrderListFrame() {
        ...
        String compId = OwnerProfile.getCompanyId().trim();
//        System.out.println("company iD :"+compId);
        loadOrderLists(compId);
    ...
    private void initComponents() {
        ...
        tbOrderList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PRODUCT NAME", "PRODUCT PRICE", "CUSTOMER NAME", "STAFF NAME", "ADDRESS", "STATUS", "REVIEW"
            }
        ) {
        ...
        if (tbOrderList.getColumnModel().getColumnCount() > 0) {
            ...
            tbOrderList.getColumnModel().getColumn(5).setResizable(false);
        }
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 280, 560));
    ...
    private void tbOrderListMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbOrderListMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_tbOrderListMouseEntered
    ...
    private void loadOrderLists(String companyId){
        try{
            orderList = OrderDAO.getAllOrderByCompanyId(companyId);
            if(orderList.isEmpty()){
                JOptionPane.showMessageDialog(null,"No any orders till now ");
            ...
            while(i<orderList.size()){
                OrderPojo ordList = orderList.get(i);
                rows[0]=ordList.getProductName();
                rows[1]=ordList.getProductPrice();
                rows[2]=ordList.getCustomerName();
                rows[3]=ordList.getDeliveryStaffName();
                rows[4]=ordList.getCustomerAddress();
                rows[5]=ordList.getStatus();
                rows[6]=ordList.getReview();
                model.addRow(rows);
                i++;
            }
