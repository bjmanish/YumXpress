...
public class SellerOptionFrame extends javax.swing.JFrame {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try{
            String[] str={"YES" , "NO"};
            int choice = JOptionPane.showOptionDialog(null, "Are you sure to delete Account ?", "Select", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, str, str[1]);
            if(choice==0){
                boolean result = CompanyDAO.DeleteAccount(OwnerProfile.getCompanyId().trim());
                if(result==true){
