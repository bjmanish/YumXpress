...
public class ViewOrderHistoryFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbOrderList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PRODUCT NAME", "PRODUCT PRICE", "CUSTOMER  NAME", "ADDRESS", "STATUS", "REVIEW"
            }
        ) {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 900, 550));
    ...
    private void loadOrderDetails(String staffId) {
        try{
            orderList=OrderDAO.getOrderDetailsByStaffId(staffId);
            if(orderList.isEmpty()){
                JOptionPane.showMessageDialog(null,"Orders not found yet");
